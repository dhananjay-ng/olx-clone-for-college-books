...
else{while($row=mysql_fetch_assoc($dhanu))
{ 
      ...
      <div class="row">
       ...
       {	
        ...
        <?php 
		 ...
		 <?php echo"<br><a class=\"btn btn-default\"id='various3' href='perticularbook.php?id=$bookid' role=\"button\">View details &raquo;</a>";
                  } ?>
